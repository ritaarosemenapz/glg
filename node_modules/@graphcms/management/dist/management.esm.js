...
var ModelClass = /*#__PURE__*/function () {
  ...
  _proto.addRelationalField = function addRelationalField(passedFieldArgs) {
    ...
    fieldArgs.isList = fieldArgs.relationType === RelationType.OneToMany || fieldArgs.relationType === RelationType.ManyToMany;
    fieldArgs.reverseField.isList = fieldArgs.relationType === RelationType.ManyToOne || fieldArgs.relationType === RelationType.ManyToMany;
  ...
  _proto.addUnionField = function addUnionField(passedFieldArgs) {
    ...
    fieldArgs.isList = fieldArgs.relationType === RelationType.OneToMany || fieldArgs.relationType === RelationType.ManyToMany;
    fieldArgs.reverseField.isList = fieldArgs.relationType === RelationType.ManyToOne || fieldArgs.relationType === RelationType.ManyToMany; // remove convenience fields
...
export { FieldType$1 as FieldType, RelationType, RemoteFieldApiMethod, RemoteFieldType, RemoteSourceIntrospectionMethod, Renderer, VisibilityTypes, newMigration };
//# sourceMappingURL=management.esm.js.map
