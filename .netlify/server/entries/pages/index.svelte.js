...
const Card = (0, import_index_511472e1.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<article class="${"card svelte-1y41kh8"}"><img class="${"post-cover svelte-1y41kh8"}"${(0, import_index_511472e1.a)("src", source, 0)}${(0, import_index_511472e1.a)("alt", alt, 0)}>
  <div class="${"card-content svelte-1y41kh8"}"><a class="${"category-badge"}"${(0, import_index_511472e1.a)("href", category.toLowerCase(), 0)}>${(0, import_index_511472e1.e)(category)}</a>
    <h3 class="${"post-title svelte-1y41kh8"}"><a${(0, import_index_511472e1.a)("href", path, 0)} class="${"svelte-1y41kh8"}">${(0, import_index_511472e1.e)(title)}</a></h3>
...
const DailyQuote = (0, import_index_511472e1.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section class="${"container svelte-jya1kz"}">${randomQuote ? `<blockquote class="${"daily-quote svelte-jya1kz"}"><p>&quot;${(0, import_index_511472e1.e)(randomQuote.text)}&quot;</p>
			<p class="${"author svelte-jya1kz"}">\u2013 ${(0, import_index_511472e1.e)(randomQuote.author)}</p></blockquote>` : `<blockquote>&quot;Women are strong as hell.&quot;</blockquote>`}
</section>`;
});
...
<main>${(0, import_index_511472e1.v)(FeaturedPost, "FeaturedPost").$$render(
	...
	<section class="${"post-grid svelte-15hqesx"}">${(0, import_index_511472e1.b)(posts, (post) => {
