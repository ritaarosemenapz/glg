...
var import_ReadMoreTag_2fe9df27 = require("../../_app/immutable/chunks/ReadMoreTag-2fe9df27.js");
...
const Card = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let { source } = $$props;
  let { title } = $$props;
  let { category } = $$props;
  let { date } = $$props;
  ...
  return `<article class="${"card svelte-1y41kh8"}"><img class="${"post-cover svelte-1y41kh8"}"${(0, import_index_27acdd93.b)("src", source, 0)}${(0, import_index_27acdd93.b)("alt", alt, 0)}>
  <div class="${"card-content svelte-1y41kh8"}"><a class="${"category-badge"}"${(0, import_index_27acdd93.b)("href", category.toLowerCase(), 0)}>${(0, import_index_27acdd93.e)(category)}</a>
    <h3 class="${"post-title svelte-1y41kh8"}"><a${(0, import_index_27acdd93.b)("href", path, 0)} class="${"svelte-1y41kh8"}">${(0, import_index_27acdd93.e)(title)}</a></h3>
    <p class="${"post-date"}">${(0, import_index_27acdd93.e)(new Date(date).toDateString())}</p>
    ${(0, import_index_27acdd93.v)(import_ReadMoreTag_2fe9df27.R, "ReadMoreTag").$$render($$result, { path }, {}, {})}</div>
</article>`;
});
const FEM_QUOTES = [
  {
...
const DailyQuote = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let randomIndex = Math.floor(Math.random() * FEM_QUOTES.length);
  let randomQuote = FEM_QUOTES[randomIndex];
  $$result.css.add(css$2);
  return `<section class="${"container svelte-jya1kz"}">${randomQuote ? `<blockquote class="${"daily-quote svelte-jya1kz"}"><p>&quot;${(0, import_index_27acdd93.e)(randomQuote.text)}&quot;</p>
			<p class="${"author svelte-jya1kz"}">\u2013 ${(0, import_index_27acdd93.e)(randomQuote.author)}</p></blockquote>` : `<blockquote>&quot;Women are strong as hell.&quot;</blockquote>`}
</section>`;
});
...
const FeaturedPost = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let { title } = $$props;
  let { cover } = $$props;
  let { category } = $$props;
  let { path } = $$props;
  ...
  return `<section class="${"svelte-8s3qpb"}"><img${(0, import_index_27acdd93.b)("src", cover, 0)}${(0, import_index_27acdd93.b)("alt", alt, 0)} class="${"svelte-8s3qpb"}">
	<div class="${"text-container svelte-8s3qpb"}"><p class="${"category-badge"}">${(0, import_index_27acdd93.e)(category)}</p>
		<h2 class="${"post-title svelte-8s3qpb"}"><a${(0, import_index_27acdd93.b)("href", path, 0)} class="${"svelte-8s3qpb"}">${(0, import_index_27acdd93.e)(title)}</a></h2>
		<p class="${"post-date"}">${(0, import_index_27acdd93.e)(date)}</p>
		${(0, import_index_27acdd93.v)(import_ReadMoreTag_2fe9df27.R, "ReadMoreTag").$$render($$result, { path }, {}, {})}</div>
</section>`;
});
...
const Routes = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let { posts } = $$props;
...
<main>${(0, import_index_27acdd93.v)(FeaturedPost, "FeaturedPost").$$render($$result, {
    path: posts[0].path,
	...
	${(0, import_index_27acdd93.v)(DailyQuote, "DailyQuote").$$render($$result, {}, {}, {})}
	<section class="${"post-grid svelte-15hqesx"}">${(0, import_index_27acdd93.d)(posts, (post) => {
    return `${posts.indexOf(post) !== 0 ? `${(0, import_index_27acdd93.v)(Card, "Card").$$render($$result, {
