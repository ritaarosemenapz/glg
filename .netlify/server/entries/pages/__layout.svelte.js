...
const Footer = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"container svelte-1lb27zc"}"><div class="${"footer-content"}"><p>${(0, import_index_27acdd93.e)(year)} \xA9 All Rights Reserved. Crafted with <!-- HTML_TAG_START -->${HEART_ICON}<!-- HTML_TAG_END --> by Rita Arosemena-Perez. Built with
...
const MobileMenu = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
...
const Header = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `${(0, import_index_27acdd93.v)(MobileMenu, "MobileMenu").$$render($$result, {}, {}, {})}
...
const _layout = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let { posts } = $$props;
  ...
  $$result.css.add(css);
  return `<header class="${"svelte-1udg5sc"}">${(0, import_index_27acdd93.v)(Header, "Header").$$render($$result, {}, {}, {})}
...
<main><article id="${"body"}">${slots.default ? slots.default({}) : ``}</article>
	${(0, import_index_27acdd93.v)(Footer, "Footer").$$render($$result, {}, {}, {})}
</main>`;
});
