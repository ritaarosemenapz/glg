...
const Sidebar = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let { name } = $$props;
  let { bio } = $$props;
  ...
  return `<aside class="${"svelte-1g4g5f7"}"><div class="${"author-info svelte-1g4g5f7"}"><div><p class="${"author-name svelte-1g4g5f7"}">By ${(0, import_index_27acdd93.e)(name)}</p>
			<p class="${"author-bio"}">${(0, import_index_27acdd93.e)(bio)}</p></div></div>
	<button class="${"support-button svelte-1g4g5f7"}" type="${"button"}" name="${"support"}">\u2615\uFE0F Buy me a coffee</button></aside>

${slots.default ? slots.default({}) : ``}`;
});
const getStores = () => {
  const stores = (0, import_index_27acdd93.g)("__svelte__");
  return {
    page: {
...
const SocialShare = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let $page, $$unsubscribe_page;
  $$unsubscribe_page = (0, import_index_27acdd93.a)(page, (value) => $page = value);
  $$unsubscribe_page();
  return `<p>Current URL: ${(0, import_index_27acdd93.e)($page.url.path)}</p>`;
});
...
const _layout_article = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let { title } = $$props;
  let { category } = $$props;
  let { cover } = $$props;
  let { date } = $$props;
  ...
  $$result.css.add(css);
  return `<div class="${"container svelte-6ry62i"}"><section class="${"post svelte-6ry62i"}"><div class="${"wrapper svelte-6ry62i"}"><div class="${"post-header svelte-6ry62i"}"><div class="${"svelte-6ry62i"}"><p class="${"category-badge svelte-6ry62i"}">${(0, import_index_27acdd93.e)(category.toUpperCase())}</p>
					<h1 class="${"svelte-6ry62i"}">${(0, import_index_27acdd93.e)(title)}</h1>
					<p class="${"svelte-6ry62i"}">${(0, import_index_27acdd93.e)(summary)}</p>
					<p class="${"svelte-6ry62i"}">By ${(0, import_index_27acdd93.e)(AUTHOR_INFO.name)}</p>
					<p class="${"post-date svelte-6ry62i"}">${(0, import_index_27acdd93.e)(new Date(date).toDateString())}</p></div>
				<div class="${"col-2 svelte-6ry62i"}"><img${(0, import_index_27acdd93.b)("src", cover, 0)}${(0, import_index_27acdd93.b)("alt", photoAlt, 0)} class="${"svelte-6ry62i"}">
					<p class="${"photo-credit svelte-6ry62i"}"><!-- HTML_TAG_START -->${photoCredit}<!-- HTML_TAG_END --></p></div></div></div></section>
	<aside class="${"svelte-6ry62i"}">${(0, import_index_27acdd93.v)(SocialShare, "SocialShare").$$render($$result, {}, {}, {})}
		${(0, import_index_27acdd93.v)(Sidebar, "Sidebar").$$render($$result, {
