...
var import_index_27acdd93 = require("./index-27acdd93.js");
...
const ReadMoreTag = (0, import_index_27acdd93.c)(($$result, $$props, $$bindings, slots) => {
  let { path } = $$props;
  if ($$props.path === void 0 && $$bindings.path && path !== void 0)
    $$bindings.path(path);
  $$result.css.add(css);
  return `<a class="${"read-more-tag svelte-1wclngl"}"${(0, import_index_27acdd93.b)("href", path, 0)}>Read more</a>`;
});
